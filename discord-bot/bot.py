...
class WelcomeBot(commands.Cog):
    ...
    async def on_member_join(self, member):
        ...
        if channel is not None:
            await channel.send(f"Hello {member.mention}! Welcome to the /r/RPI Discord server. Most of the talk happens in student and alumni-only channels. Go to #welcome to see how tp gett verified. If you're an incoming student, just say so and we will give you the role. Max is a sussy baka.")
